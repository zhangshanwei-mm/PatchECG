...
from dataloader import data_generator,my_data
...
parser.add_argument('--seed', default=40, type=int, help='seed value')
...
def main(args, configs, seed=None):
    ...
    # Load datasets
    sourcedata_path = f"./dataset/{sourcedata}"  # './data/EpSilepsy'
    ...
    # our_test_0_layout = Tester(model, model_optimizer, model_scheduler, train_dl, valid_dl, test_dl, device, logger,
    ...
    # 5 : 12 
    # 6 : 各种排布随机出现 -l --layout 
    # test_0_layout = my_data(configs, training_mode,subset=subset,layout=0)
    # test_1_layout = my_data(configs, training_mode,subset=subset,layout=1)
    # test_2_layout = my_data(configs, training_mode,subset=subset,layout=2)
    # test_3_layout = my_data(configs, training_mode,subset=subset,layout=3)
    # test_4_layout = my_data(configs, training_mode,subset=subset,layout=4)
    # test_random = my_data(configs, training_mode,subset=subset,layout=6)
...
if __name__ == '__main__':
    ...
    configs = Configs() # SleepEEG_config
