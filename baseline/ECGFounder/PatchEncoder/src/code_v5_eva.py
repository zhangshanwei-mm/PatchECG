...
def eva_classify_model(pic_path,table_path,layout,verbose):
    ...
    model1 = Net1D(
        ...
        use_do=False,
        n_classes=768)
    # 重新train 好了一版才对，不需要进行冻结

    # 加载模型
    parameters = torch.load('/data/0shared/zhangshanwei/ECG_founder/ECGFounder-master/PatchEncoder/model/5fold/checkpoint_30.pth', map_location='cuda:9')
